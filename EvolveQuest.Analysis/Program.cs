...
namespace EvolveScavengerHunt.Analysis
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      var projects = new List<Solution> {
				...
				new Solution {
					Name = "iOS",
					ProjectFiles = new List<string> {
						Path.Combine(path, "EvolveQuest.iOS/EvolveQuest.iOS.csproj"),
						Path.Combine(path, "EvolveQuest.Shared/EvolveQuest.Shared.projitems")
					},
				},
                ...
                new Solution {
					Name = "WP8",
					ProjectFiles = new List<string> {
						Path.Combine(path, "EvolveQuest.WinPhone/EvolveQuest.WinPhone.csproj"),
						Path.Combine(path, "EvolveQuest.Shared/EvolveQuest.Shared.projitems")
					},
				},
                ...
                new Solution {
					Name = "Tester",
					ProjectFiles = new List<string> {
						Path.Combine(path, "Tester/Tester.csproj"),
						Path.Combine(path, "EvolveQuest.Shared/EvolveQuest.Shared.projitems")
					},
				},
